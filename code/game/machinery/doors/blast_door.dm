...
/obj/machinery/door/blast
	...
	var/closed_plane = ABOVE_HUMAN_PLANE
	var/id = 1.0
	dir = 1
...
/obj/machinery/door/blast/proc/force_open()
	src.operating = 1
	playsound(src.loc, open_sound, 60, 1)
...
/obj/machinery/door/blast/proc/force_close()
	src.operating = 1
	playsound(src.loc, close_sound, 60, 1)
	src.layer = closed_layer
	src.plane = closed_plane
...
/obj/machinery/door/blast/close()
	...
	for(var/mob/living/M in src.loc)
		if(prob(30))
			...
			M.apply_damage(rand(40, damage), BRUTE, BP_R_ARM)
			M.KnockDown()
			M.updatehealth()
	force_close()
...
/obj/machinery/door/blast/id_door
	...
	open_sound = 'sound/machines/id_door_open.ogg'
	close_sound = 'sound/machines/id_door_close.ogg'
	open_layer = ABOVE_WINDOW_LAYER
