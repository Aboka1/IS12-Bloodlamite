...
//I'd hook into the brainmob's destroy myself, since it'll work if someone goes and makes a snowflake brain for something else too. Like synthetics. - NOTES FROM
