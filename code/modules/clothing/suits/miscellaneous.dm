...
/obj/item/clothing/suit/kaneda
	name = "Torchiok bomber"
	icon_state = "kaneda"
...
/obj/item/clothing/suit/storage/toggle/hoodie/smw
	name = "Trench Mountain Wind hoodie"
	desc = "A warm, black sweatshirt.  It has the logo for the popular softdrink Trench Mountain Wind on both the front and the back."
...
/obj/item/clothing/suit/rags
	name = "Rags"
	desc = "It looks very dirty and shabby."
	icon_state = "bestarmor"
	body_parts_covered = UPPER_TORSO|LOWER_TORSO
	armor = list(melee = 1, bullet = 1, laser = 1, energy = 0, bomb = 1, bio = 0, rad = 0)