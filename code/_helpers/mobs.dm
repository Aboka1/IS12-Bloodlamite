...
proc/random_skinless_name(gender)
	if(gender==FEMALE)
...
/proc/get_exposed_defense_zone(var/atom/movable/target)
	return pick(BP_HEAD, BP_NECK, BP_L_HAND, BP_R_HAND, BP_L_FOOT, BP_R_FOOT, BP_L_ARM, BP_R_ARM, BP_L_LEG, BP_R_LEG, BP_CHEST, BP_GROIN)
